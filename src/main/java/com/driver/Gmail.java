...
public class Gmail extends Email {
    ...
    List<Oops> inbox = new ArrayList<>();
    List<Oops> trash = new ArrayList<>();
    int inboxCapacity=3; //maximum number of mails inbox can store
    ...
    public void receiveMail(Date date, String sender, String message){
        ...
        Oops e = new Oops(date, sender, message);
        inbox.add(e);
    }
